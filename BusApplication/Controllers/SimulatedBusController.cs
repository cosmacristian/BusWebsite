...
namespace BusApplication.Controllers
{
    public class SimulatedBusController : Controller
    {
        ...
        {
            var simulatedBus = db.SimulatedBus.Include(s => s.Buses);
        ...
        public ActionResult Details(int? id)
        {
            ...
            SimulatedBus simulatedBus = db.SimulatedBus.Find(id);
        ...
        public ActionResult Create([Bind(Include = "Id,LastCheckin,Measurement_Timestamp,BusId")] SimulatedBus simulatedBus)
        {
