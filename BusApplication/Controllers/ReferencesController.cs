...
namespace BusApplication.Controllers
{
    public class ReferencesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,From,To,duration,intervalTime")] References references)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,From,To,duration,intervalTime")] References references)
        {
            if (ModelState.IsValid)
            {
