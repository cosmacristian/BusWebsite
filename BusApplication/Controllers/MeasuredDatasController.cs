...
namespace BusApplication.Controllers
{
    public class MeasuredDatasController : Controller
    {
        ...
        {
            return View(db.MeasuredData.ToList());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            MeasuredData measuredData = db.MeasuredData.Find(id);
        ...
        public ActionResult Create([Bind(Include = "ID,From,To,duration,dateTime")] MeasuredData measuredData)
        {
            ...
            {
                db.MeasuredData.Add(measuredData);
                db.SaveChanges();
        ...
        {
            MeasuredData measuredData = db.MeasuredData.Find(id);
            db.MeasuredData.Remove(measuredData);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
