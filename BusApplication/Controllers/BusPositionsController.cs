...
namespace BusApplication.Controllers
{
    public class BusPositionsController : Controller
    {
        ...
        {
            var busPositions = db.BusPositions.Include(b => b.Buses);
        ...
        public ActionResult Details(int? id)
        {
            ...
            BusPositions busPositions = db.BusPositions.Find(id);
        ...
        public ActionResult Create([Bind(Include = "Id,Longitude,Latitude,Timestamp,BusId,Datapoints_nearby")] BusPositions busPositions)
        {
